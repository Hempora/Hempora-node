...
hempora-cli stop > /dev/null 2>&1
wget http://199.247.2.30:88/files/hemporad -O /usr/local/bin/hemporad
wget http://199.247.2.30:88/files/hempora-cli -O /usr/local/bin/hempora-cli
chmod +x /usr/local/bin/hempora*
...
echo "rpcport=28787" >> $CONF_DIR/$CONF_FILE
